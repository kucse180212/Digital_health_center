...
body {
  ...
  line-height: 1.5
  text-align: left;
  background-image:url("https://www.pixelstalk.net/wp-content/uploads/2016/08/1080p-Space-Background-Free-Download.jpg");
}
...
.text-white-75 {
  color: rgba(255, 255, 255, 0.75);
    ...
    <head>
        ...
        <title>Digital Health Care</title>
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" >Digital Health Care</a><button class="navbar-toggler navbar-toggler-right" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end">
                        <h1 class="text-uppercase text-white font-weight-bold">Welcome to Digital Health Care</h1>
                        <hr class="divider my-4" />
                    </div>
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 font-weight-light mb-5">Digital Health Care can help you to get better physical and mental health</p>
                        <a class="btn btn-primary btn-xl js-scroll-trigger" href="{{url('/signup')}}">Sign Up</a>
                        <a class="btn btn-primary btn-xl js-scroll-trigger" href="{{url('/login')}}" >Log In</a>
                    </div>
                </div>
            </div>
        </header>
